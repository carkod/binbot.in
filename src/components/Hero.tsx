        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground font-light max-w-2xl mb-10 leading-relaxed">
              Binbot is 100% focused on cryptocurrency — running systematic
              algorithms across the full spectrum of digital assets to maximise
              profitability while actively hedging against volatility. We favour
              low-cap assets where the greatest growth potential lies, using
              Bitcoin as a market reference rather than a constraint. Our
              mission is to offer a credible, professionally managed alternative
              to a market that has long been out of reach for most investors.
            </p>
