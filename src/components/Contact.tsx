          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-8 pb-8 border-b border-border">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h5 className="text-sm text-foreground font-semibold mb-0.5">Investor Relations</h5>
                  <p className="text-xs text-muted-foreground">allocators@binbot.in</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 border border-border bg-background flex items-center justify-center flex-shrink-0 shadow-sm">
                ...
                <div>
                  <h5 className="text-sm text-foreground font-semibold mb-0.5">Headquarters</h5>
